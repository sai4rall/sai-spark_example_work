...
//# Note: The status picklist for wireless deployments; OCN WirelessDeployment StatusPicklist and arcollDeployment StatusPacklist
    private  Map<String, String> cellStatusMapDict = Map.of(
    ...
    private Map<String, String> statusMapDict = Map.ofEntries(
...
//        # Note: A number of these cellTypes will need to be created in ocw:telstraCellTypePicklist
    private Map<String, String> cellTypeMapDict = Map.ofEntries(
    ...
    private Map<Integer, String> cellFunctionbict = Map.of(
            1, "Coverage",
            2, "Capacity",
            3, "Other");
    ...
    private Map<String, String> validiscNodeDict = Map.ofEntries(
    ...
    private Map<Integer, String> areaCodeDict = Map.of(
            2, "02",
            3, "03",
            7, "07",
            8, "08",
    ...
    private Map<String, String> ranNumberingDict = Map.ofEntries(
            Map.entry("10", "A"),
            Map.entry("11", "B"),
            Map.entry("12", "C"),
            Map.entry("13", "D"),
    ...
    public Map<String, String> getCellStatusMapDict() {
        return cellStatusMapDict;
    }

    public Map<String, String> getStatusMapDict() {
        return statusMapDict;
    }

    public Map<String, String> getCellTypeMapDict() {
        return cellTypeMapDict;
    }

    public Map<Integer, String> getCellFunctionbict() {
        return cellFunctionbict;
    }

    public Map<String, String> getValidiscNodeDict() {
        return validiscNodeDict;
    }

    public Map<Integer, String> getAreaCodeDict() {
        return areaCodeDict;
    }

    public Map<String, String> getRanNumberingDict() {
        return ranNumberingDict;
    }
}
